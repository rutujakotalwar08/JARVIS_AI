...
def AuthenticateFace():
    ...
    recognizer.read('Jarvis-2025-master\\backend\\auth\\trainer\\trainer.yml')  # load trained model
    cascadePath = "Jarvis-2025-master\\backend\\auth\haarcascade_frontalface_default.xml"
